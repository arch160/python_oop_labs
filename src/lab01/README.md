...
### Инкапсуляция (почему нужно прятать данные)
Если будет:

book.pages = -100 ( Книга с отрицательным числом страниц не существует )
или
book.is_available = False ( А если книга уже выдана )

Значит, нужно:
- Спрятать атрибуты (сделать их защищёнными с _)
- Контролировать доступ через специальные методы
- Добавить проверки при изменении данных
...
![1](../../images/lab01/сц%201.png)

### 2. Валидация данных и setter
![2](../../images/lab01/сц%202.png)

### 3. Состояние объекта и бизнес-методы
![3](../../images/lab01/сц%203.png)


### 4. Дополнительные возможности
![4](../../images/lab01/сц%204.png)